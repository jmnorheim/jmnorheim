...
<ul>
  ...
  <li>🌐 A movie-database website written in React + TS using GraphQL for queries, TanStack Query for fetching. Custom backend with an Apollo Server and Prisma Database</li>
</ul>
